...
def test_config_build_segmentor():
    ...
    for config_fname in config_names:
        ...
        segmentor = build_segmentor(
            config_mod.model, train_cfg=config_mod.train_cfg, test_cfg=config_mod.test_cfg
        )
...
def _check_decode_head(decode_head_cfg, decode_head):
    ...
    if decode_head_cfg["type"] == "PointHead":
        assert (
            decode_head_cfg.channels + decode_head_cfg.num_classes == decode_head.fc_seg.in_channels
        )
