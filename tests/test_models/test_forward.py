...
def test_deeplabv3_forward():
    _test_encoder_decoder_forward("deeplabv3/deeplabv3_r50-d8_512x1024_40k_cityscapes.py")


def test_deeplabv3plus_forward():
    _test_encoder_decoder_forward("deeplabv3plus/deeplabv3plus_r50-d8_512x1024_40k_cityscapes.py")
...
def test_nonlocal_net_forward():
    _test_encoder_decoder_forward("nonlocal_net/nonlocal_r50-d8_512x1024_40k_cityscapes.py")
