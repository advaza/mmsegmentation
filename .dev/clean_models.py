...
SCHEDULES_LUT = {"20ki": 20000, "40ki": 40000, "60ki": 60000, "80ki": 80000, "160ki": 160000}
...
def main():
    ...
    for model in model_infos:
        ...
        for checkpoints in mmcv.scandir(osp.join(models_root, model["config"]), suffix=".pth"):
            if checkpoints.endswith(f"iter_{model['iters']}.pth") or checkpoints.endswith(
                "latest.pth"
            ):
                continue
            print("removing {}".format(osp.join(models_root, model["config"], checkpoints)))
